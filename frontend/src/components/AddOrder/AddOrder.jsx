            ...
            <form className="order-form" onSubmit={handleSubmit}>
                ...
                <div className="products-section">
                    ...
                    <div className="add-product-form">
                        <div className="form-group">
                            <select name="productType" value={newProduct.productType} onChange={handleProductChange}>
                        ...
                        <div className="form-group">
                            <input type="text" name="unitPrice" placeholder="Unit Price" value={newProduct.unitPrice} readOnly />
                        </div>
                ...
                <div className="form-group">
                    ...
                    <input type="text" name="totalPrice" value={inputs.totalPrice} readOnly className={errors.totalPrice ? 'error-input' : ''} required />
